...
Post2 = Post2 & "User-Agent: Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.1; YComp 5.0.0.0; .NET CLR 1.0.3705)" & vbCrLf
...
Gett = ""
Gett = Gett & "GET " & thePage & " HTTP/1.1" & vbCrLf
...
Gett = Gett & "User-Agent: Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.1; YComp 5.0.0.0; .NET CLR 1.0.3705)" & vbCrLf
If theReferer <> "" Then Gett = Gett & "Referer: " & theReferer & vbCrLf
If theHost <> "" Then Gett = Gett & "Host: " & theHost & vbCrLf
Gett = Gett & "Connection: Keep -Alive" & vbCrLf
